			...
			<div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0 fontnav">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <i
								class="bi bi-people-fill"></i> Download</a>
	...
	<section id="aboutme" class="bg-light">
        ...
        > -->
			<div class="row pb-4 justify-content-center">
				<div class="col-2"></div>
				<div class="col-8 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores a harum explicabo est? Aperiam dolore
					asperiores reiciendis debitis tempora optio itaque quam quasi dolorum aliquid? Quae natus perferendis atque laborum!</div>
				<div class="col-2"></div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid d-flex flex-column align-items-center p-4">
			...
			<div class="row mb-4">
				...
				<div class="col-md-6">
					...
					<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores fugit quod cumque provident quasi! Ut minus veritatis sed atque,
						aut modi fugit? Veniam quos voluptatum harum cumque vero, numquam dolore! [ <a href="detailblog.html">Baca Selengkapnya</a> ]</p>
					<hr />
				</div>
			</div>
			<div class="row mb-4">
				...
				<div class="col-md-6">
					...
					<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores fugit quod cumque provident quasi! Ut minus veritatis sed atque,
						aut modi fugit? Veniam quos voluptatum harum cumque vero, numquam dolore! [ <a href="#">Baca Selengkapnya</a> ]</p>
					<hr />
				</div>
			</div>
		</div>
